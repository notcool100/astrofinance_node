...
export const createAccountValidation = [
  ...
  body('accountType')
    ...
    .isIn(['SAVINGS', 'LOAN', 'FIXED_DEPOSIT'])
    .withMessage('Account type must be one of: SAVINGS, LOAN, FIXED_DEPOSIT'),
  ...
  body('bbAccountDetails.guardianIdType')
    ...
    .withMessage('Guardian ID type must be one of: NATIONAL_ID, PASSPORT, DRIVING_LICENSE, OTHER'),
