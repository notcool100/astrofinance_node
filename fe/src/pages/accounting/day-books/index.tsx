...
import { PlusIcon, EyeIcon, LockClosedIcon, CheckCircleIcon } from '@heroicons/react/24/outline';
...
const DayBooksPage: React.FC = () => {
  ...
  const fetchDayBooks = async () => {
    setLoading(true);
    try {
      const { data, pagination: paginationData } = await dayBookService.getAllDayBooks({
        page: pagination.page,
        limit: pagination.limit,
        startDate: filters.startDate || undefined,
        endDate: filters.endDate || undefined,
        isReconciled: filters.isReconciled ? filters.isReconciled === 'true' : undefined,
      ...
      toast.error(error instanceof Error ? error.message : 'Failed to fetch day books');
    } finally {
      setLoading(false);
    }
  };
        ...
        <div className="px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="bg-white shadow rounded-lg mb-6">
            ...
            <div className="px-4 py-5 sm:p-6">
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div>
                  <label htmlFor="isReconciled" className="block text-sm font-medium text-gray-700">
          ...
          <div className="bg-white shadow rounded-lg overflow-hidden">
            <div className="overflow-x-auto">
              {loading ? (
                <div className="px-6 py-4 text-center text-gray-500">Loading day books...</div>
              ) : dayBooks.length === 0 ? (
                <div className="px-6 py-4 text-center text-gray-500">No day books found</div>
              ) : (
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {dayBooks.map(dayBook => (
                      <tr key={dayBook.id}>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                          {dayBook.physicalCashBalance 
                            ? formatCurrency(dayBook.physicalCashBalance) 
                            : 'Not reconciled'}
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
