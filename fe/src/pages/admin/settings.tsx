...
const settingSchema = yup.object().shape({
  ...
  dataType: yup.string().oneOf(['STRING', 'NUMBER', 'BOOLEAN', 'JSON', 'DATE', 'EMAIL', 'URL', 'PHONE']).required('Data type is required'),
...
const SettingsPage: React.FC = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      Cell: ({ row }: { row: any }) => {
        ...
        const displayValue = setting.isEncrypted ? '••••••••' : getSettingValue(setting);
        ...
        return (
          <span className="text-sm max-w-xs truncate" title={String(displayValue)}>
            {String(displayValue)}
          </span>
        );
      },
  ...
  const categoryTabs = [
    ...
    { id: 'business', name: 'Business', icon: BuildingOfficeIcon, category: 'BUSINESS' },
    { id: 'contact', name: 'Contact', icon: GlobeAltIcon, category: 'CONTACT' },
    { id: 'loan', name: 'Loan', icon: CurrencyDollarIcon, category: 'LOAN' },
    { id: 'notification', name: 'Notifications', icon: BellIcon, category: 'NOTIFICATION' },
    { id: 'security', name: 'Security', icon: ShieldCheckIcon, category: 'SECURITY' },
    ...
    <ProtectedRoute adminOnly>
      <MainLayout title="System Settings">
        <div className="px-4 sm:px-6 lg:px-8 py-8">
          ...
          {/* Settings Table */}
          <Card title={`${categoryTabs.find(t => t.id === activeTab)?.name} Settings`}>
            {isLoadingSettings ? (
          ...
          <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                {form.formState.errors.dataType && (
                  <p className="form-error">{form.formState.errors.dataType.message}</p>
                )}
              </div>
            </div>
            ...
            <div className="flex justify-end space-x-3">
              ...
              <Button
                type="submit"
                variant="primary"
                loading={createSettingMutation.isLoading || updateSettingMutation.isLoading}
              >
