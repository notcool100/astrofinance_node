...
const LoanDetailsPage = () => {
	...
	const handleSettlementClick = async () => {
		...
		try {
			...
			const oneMonthInterest =
				remainingPrincipal * (loanData.interestRate / 12 / 100);
					...
					<div className="flex justify-between items-center">
						...
						<div className="flex space-x-2">
							<Button
								...
								onClick={() =>
									router.push(
										`/loans/calculator?loanTypeId=${loanData.loanType?.id}`,
									)
								}
							>
								Loan Calculator
								...
								<div className="space-y-4">
									...
									{loanData.closureDate && (
										<div>
											...
											<dd className="mt-1 text-sm text-gray-900">
												{formatDate(loanData.closureDate)}
											</dd>
										</div>
									)}
								</div>
									...
									<div className="grid grid-cols-1 gap-6 sm:grid-cols-3">
										<div className="bg-gray-50 p-4 rounded-md">
											...
											<dd className="mt-1 text-xl font-semibold text-gray-900">
												{formatCurrency(
													loanData.amount + calculateTotalInterest(),
												)}
											</dd>
											<p className="mt-1 text-xs text-gray-500">
												Principal: {formatCurrency(loanData.amount)} + Interest:{" "}
												...
												<div className="flex justify-between items-center">
													...
													<div className="text-right">
														...
														<Button
															...
															className="mt-2"
															onClick={() =>
																router.push(`/loans/${id}/repayment`)
															}
														>
															Pay Now
														</Button>
									...
									<div className="mt-3 text-center sm:mt-5">
										...
										<div className="mt-2">
											{isCalculatingSettlement ? (
												...
												<div>
													<p className="text-sm text-gray-500">
														You can settle your loan early by paying the
														settlement amount below. This will close your loan
														and you will not have to make any further payments.
													</p>
													...
													<div className="mt-4">
														<p className="text-sm text-gray-500">
															By settling early, you save approximately{" "}
															{formatCurrency(
																calculateRemainingAmount() - settlementAmount,
															)}{" "}
															compared to continuing with your regular EMI
															payments.
														</p>
													</div>
												</div>
												...
												<p className="text-sm text-gray-500">
													Failed to calculate settlement amount. Please try
													again.
												</p>
											)}
										</div>
