...
import { ArrowLeftIcon, CreditCardIcon, BanknotesIcon, CheckCircleIcon } from '@heroicons/react/24/outline';
...
const paymentSchema = yup.object().shape({
  ...
  reference: yup
    ...
    .when('paymentMethod', {
      ...
      then: yup.string().required('Reference number is required for this payment method'),
...
const LoanRepaymentPage = () => {
  ...
  const [selectedInstallment, setSelectedInstallment] = useState<LoanSchedule | null>(null);
  ...
  // Fetch loan schedule
  const { data: schedule, isLoading: isLoadingSchedule, refetch: refetchSchedule } = useQuery(
    ['loanSchedule', id],
    ...
    <ProtectedRoute>
      <MainLayout title="Loan Repayment">
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
              ...
              <div className="px-4 py-5 sm:p-6">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <dd className="mt-1 text-sm text-gray-900">{loanData.loanNumber}</dd>
                  </div>
                  <div>
            ...
            <div className="lg:col-span-2">
              <div className="grid grid-cols-1 gap-6 sm:grid-cols-3">
                <Card className="bg-green-50 border border-green-100">
                  <div className="px-4 py-5 sm:p-6">
                    ...
                    <p className="mt-2 text-sm text-gray-500">
                      {scheduleData.filter(i => i.status === 'PAID').length} of {scheduleData.length} installments paid
                    </p>
                  </div>
                </Card>
                ...
                <Card className="bg-yellow-50 border border-yellow-100">
                  <div className="px-4 py-5 sm:p-6">
                    ...
                    <p className="mt-2 text-sm text-gray-500">
                      {scheduleData.filter(i => i.status === 'PENDING' || i.status === 'OVERDUE').length} installments remaining
                    </p>
                  </div>
                </Card>
                ...
                <Card className="bg-red-50 border border-red-100">
                  <div className="px-4 py-5 sm:p-6">
                    <h3 className="text-sm font-medium text-gray-900">Total Overdue</h3>
                    <div className="mt-2 flex items-baseline">
                      <p className="text-2xl font-semibold text-gray-900">
                    ...
                    <p className="mt-2 text-sm text-gray-500">
                      {scheduleData.filter(i => i.status === 'OVERDUE').length} overdue installments
                    </p>
                  </div>
                </Card>
              </div>
              ...
              {nextDueInstallment && (
                <Card className="mt-6">
                  <div className="px-4 py-5 sm:p-6">
                    <h3 className="text-lg font-medium leading-6 text-gray-900 mb-4">Next Payment Due</h3>
                    ...
                    <div className="bg-gray-50 p-4 rounded-md">
                      <div className="flex justify-between items-center">
                        <div>
                          ...
                          <div className="mt-2">
                            <InstallmentStatusBadge status={nextDueInstallment.status} />
                          </div>
                        </div>
          ...
          <Card>
            <div className="px-4 py-5 sm:p-6">
              <h3 className="text-lg font-medium leading-6 text-gray-900 mb-4">Repayment Schedule</h3>
              ...
              <div className="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6">
                {paymentSuccess ? (
                  ...
                  <>
                    <div>
                      <div className="mt-3 text-center sm:mt-0 sm:text-left">
                        <h3 className="text-lg leading-6 font-medium text-gray-900">
                          Make Payment - Installment #{selectedInstallment.installmentNumber}
                        </h3>
                        <div className="mt-2">
                          ...
                          <p className="text-sm text-gray-500">
                            Amount Due: {formatCurrency(selectedInstallment.amount)}
                          </p>
                    ...
                    <form onSubmit={handleSubmit(handlePaymentSubmit)} className="mt-5 space-y-4">
                      <div>
                      ...
                      <div>
                        ...
                        <input
                          ...
                          className={`form-input mt-1 block w-full sm:text-sm rounded-md ${
                            errors.paymentDate ? 'border-red-300 focus:ring-red-500 focus:border-red-500' : ''
                          }`}
                      ...
                      <div>
                        ...
                        <select
                          ...
                          className={`form-select mt-1 block w-full sm:text-sm rounded-md ${
                            errors.paymentMethod ? 'border-red-300 focus:ring-red-500 focus:border-red-500' : ''
                          }`}
                      ...
                      <div>
                        ...
                        <input
                          ...
                          id="reference"
                          className={`form-input mt-1 block w-full sm:text-sm rounded-md ${
                            errors.reference ? 'border-red-300 focus:ring-red-500 focus:border-red-500' : ''
                          }`}
