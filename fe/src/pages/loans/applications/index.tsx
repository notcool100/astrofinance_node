						...
						<div className="px-4 py-5 sm:p-6">
							...
							<div className="mt-8 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
								...
								<div>
									...
									<p className="mt-2 text-sm text-gray-500">
										Our team reviews your application and makes a decision based
										on your eligibility.
									</p>
								</div>
								<div>
									...
									<p className="mt-2 text-sm text-gray-500">
										Upload required documents to verify your identity, address,
										and income.
									</p>
								</div>
								<div>
									...
									<p className="mt-2 text-sm text-gray-500">
										Once approved and verified, the loan amount is disbursed to
										your account.
									</p>
								</div>
							</div>
