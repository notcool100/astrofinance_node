...
const OfficeDashboard = () => {
  const { isAuthenticated, isOfficeUser, isAdmin, isStaff, hasPermission, isLoading: authLoading } = useAuth();
  const router = useRouter();

  // Fetch dashboard data
  const { data: dashboardData, isLoading: isDashboardLoading } = useQuery(
    'officeDashboardSummary',
    fetchDashboardSummary,
    {
      enabled: isAuthenticated && isOfficeUser,
    ...
    <MainLayout title="Office Dashboard">
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {/* Only show users card if user has permission */}
            ...
            <Card className="bg-white overflow-hidden shadow rounded-lg">
              ...
              <div className="bg-gray-50 px-5 py-3">
                <div className="text-sm">
                  <a href="/office/users" className="font-medium text-primary-700 hover:text-primary-900">
                    View all
                  </a>
                </div>
              </div>
          ...
          {hasPermission('loans.view') && (
            <Card className="bg-white overflow-hidden shadow rounded-lg">
              ...
              <div className="bg-gray-50 px-5 py-3">
                <div className="text-sm">
                  <a href="/office/loans" className="font-medium text-primary-700 hover:text-primary-900">
                    View all
                  </a>
                </div>
              </div>
          ...
          {hasPermission('loan.applications.view') && (
            <Card className="bg-white overflow-hidden shadow rounded-lg">
              <div className="p-5">
                <div className="flex items-center">
                  <div className="flex-shrink-0">
              ...
              <div className="bg-gray-50 px-5 py-3">
                <div className="text-sm">
                  <a href="/office/applications" className="font-medium text-primary-700 hover:text-primary-900">
                    View all
                  </a>
                </div>
              </div>
          ...
          {hasPermission('accounting.view') && (
            <Card className="bg-white overflow-hidden shadow rounded-lg">
              ...
              <div className="bg-gray-50 px-5 py-3">
                <div className="text-sm">
                  <a href="/office/reports/disbursements" className="font-medium text-primary-700 hover:text-primary-900">
                    View details
                  </a>
                </div>
              </div>
          ...
          {hasPermission('accounting.view') && (
            <Card className="bg-white overflow-hidden shadow rounded-lg">
              ...
              <div className="bg-gray-50 px-5 py-3">
                <div className="text-sm">
                  <a href="/office/reports/collections" className="font-medium text-primary-700 hover:text-primary-900">
                    View details
                  </a>
                </div>
              </div>
          ...
          {hasPermission('staff.view') && (
            <Card className="bg-white overflow-hidden shadow rounded-lg">
              ...
              <div className="bg-gray-50 px-5 py-3">
                <div className="text-sm">
                  <a href="/office/staff" className="font-medium text-primary-700 hover:text-primary-900">
                    View all
                  </a>
                </div>
              </div>
                        ...
                        <div className="min-w-0 flex-1 pt-1.5 flex justify-between space-x-4">
                          <div>
                            <p className="text-sm text-gray-500">
                              ...
                              <a href={`/office/users/${activity.user.id}`} className="font-medium text-gray-900">
                                {activity.user.name}
                              </a>
                            </p>
                          </div>
        ...
        <Card title="Quick Actions">
          <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
            ...
            {hasPermission('loan.applications.review') && (
              <a
                href="/office/applications/pending"
                className="inline-block rounded-md bg-white px-4 py-6 text-center shadow-md hover:shadow-lg transition-shadow duration-200"
              >
            ...
            {hasPermission('loans.disburse') && (
              <a
                href="/office/loans/disburse"
                className="inline-block rounded-md bg-white px-4 py-6 text-center shadow-md hover:shadow-lg transition-shadow duration-200"
              >
                <BanknotesIcon className="mx-auto h-8 w-8 text-primary-600" />
                <h3 className="mt-2 text-sm font-medium text-gray-900">Disburse Loan</h3>
              </a>
            )}
            
            {hasPermission('reports.view') && (
              <a
                href="/office/reports/generate"
                className="inline-block rounded-md bg-white px-4 py-6 text-center shadow-md hover:shadow-lg transition-shadow duration-200"
              >
                <ChartBarIcon className="mx-auto h-8 w-8 text-primary-600" />
