...
import transactionService, { Transaction, TransactionSummary as TransactionSummaryType } from '../../../services/transaction.service';
  ...
  const fetchAccountDetails = async (accountId: string) => {
    try {
      ...
      if (account && account.accountNumber) {
        setFilters(prev => ({ ...prev, accountNumber: account.accountNumber }));
      }
    } catch (error) {
          ...
          <div className="flex justify-between items-center mb-6">
            <div>
              <ClientOnly>
                ...
                {filters.accountNumber && (
                  <p className="text-gray-600">Filtered by Account Number: {filters.accountNumber}</p>
                )}
                <p className="text-sm text-gray-500 mt-1">Showing transactions across all accounts</p>
              </ClientOnly>
            </div>
            <Button 
              variant="primary" 
