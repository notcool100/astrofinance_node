...
export const fetchUserNavigation = async (): Promise<NavigationItem[]> => {
	try {
		const response =
			await apiService.get<NavigationItem[]>("/office/navigation");
		return response;
	} catch (error) {
...
export const fetchAllNavigationItems = async (): Promise<NavigationItem[]> => {
	try {
		const response =
			await apiService.get<NavigationItem[]>("/admin/navigation");
		return response;
	} catch (error) {
...
export const fetchNavigationGroups = async (): Promise<NavigationGroup[]> => {
	try {
		const response = await apiService.get<NavigationGroup[]>(
...
export const createNavigationItem = async (
	...
	try {
		const response = await apiService.post<NavigationItem>(
			"/admin/navigation",
			data,
		);
		return response;
...
export const updateNavigationItem = async (
	...
	try {
		const response = await apiService.put<NavigationItem>(
			`/admin/navigation/${id}`,
			data,
		);
		return response;
...
export const createNavigationGroup = async (
	data: Partial<NavigationGroup>,
): Promise<NavigationGroup> => {
	try {
		const response = await apiService.post<NavigationGroup>(
			"/admin/navigation/groups",
			data,
		);
		return response;
...
export const updateNavigationGroup = async (
	...
	try {
		const response = await apiService.put<NavigationGroup>(
 ...
 * @returns Success message
 */
export const deleteNavigationGroup = async (
	id: string,
): Promise<{ message: string }> => {
	try {
		const response = await apiService.delete<{ message: string }>(
 ...
 */
export const getNavigationGroupById = async (
	id: string,
): Promise<NavigationGroup> => {
	try {
		const response = await apiService.get<NavigationGroup>(
 ...
 */
export const getNavigationItemById = async (
	id: string,
): Promise<NavigationItem> => {
	try {
		const response = await apiService.get<NavigationItem>(
			`/admin/navigation/${id}`,
		);
		return response;
	} catch (error) {
